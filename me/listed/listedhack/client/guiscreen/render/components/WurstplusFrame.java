...
public class WurstplusFrame {
   ...
   public WurstplusFrame(WurstplusCategory category) {
      ...
      this.move_x = 0;
      this.move_y = 0;
      int size = ListedHack.get_hack_manager().get_modules_with_category(category).size();
      int count = 0;
      Iterator var4 = ListedHack.get_hack_manager().get_modules_with_category(category).iterator();
   ...
   public void refresh_frame(WurstplusModuleButton button, int combo_height) {
      this.height = 25;
      int size = ListedHack.get_hack_manager().get_modules_with_category(this.category).size();
      int count = 0;
      Iterator var5 = this.module_button.iterator();

      while(var5.hasNext()) {
         WurstplusModuleButton buttons = (WurstplusModuleButton)var5.next();
         buttons.set_y(this.height);
         ++count;
         byte compare;
         if (count >= size) {
   ...
   public boolean is_binding() {
      ...
      while(var2.hasNext()) {
         WurstplusModuleButton buttons = (WurstplusModuleButton)var2.next();
   ...
   public void bind(char char_, int key) {
      ...
      while(var3.hasNext()) {
         WurstplusModuleButton buttons = (WurstplusModuleButton)var3.next();
   ...
   public void mouse(int mx, int my, int mouse) {
      ...
      while(var4.hasNext()) {
         WurstplusModuleButton buttons = (WurstplusModuleButton)var4.next();
   ...
   public void render(int mx, int my) {
      ...
      int nc_r = ListedHack.click_gui.theme_frame_name_r;
      int nc_g = ListedHack.click_gui.theme_frame_name_g;
      int nc_b = ListedHack.click_gui.theme_frame_name_b;
      int nc_a = ListedHack.click_gui.theme_frame_name_a;
      int bg_r = ListedHack.click_gui.theme_frame_background_r;
      int bg_g = ListedHack.click_gui.theme_frame_background_g;
      int bg_b = ListedHack.click_gui.theme_frame_background_b;
      int bg_a = ListedHack.click_gui.theme_frame_background_a;
      int bd_r = ListedHack.click_gui.theme_frame_border_r;
      int bd_g = ListedHack.click_gui.theme_frame_border_g;
      int bd_b = ListedHack.click_gui.theme_frame_border_b;
      ...
      int border_size = 1;
      WurstplusDraw.draw_rect(this.x - 1, this.y, this.width + 1, this.height, bd_r, bd_g, bd_b, border_a, border_size, "left-right");
      ...
      while(var19.hasNext()) {
         WurstplusModuleButton buttons = (WurstplusModuleButton)var19.next();
