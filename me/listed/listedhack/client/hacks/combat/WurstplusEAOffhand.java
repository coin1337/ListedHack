...
public class WurstplusEAOffhand extends WurstplusHack {
   WurstplusSetting switch_mode = this.create("Offhand", "OffhandOffhand", "Crystal", this.combobox(new String[]{"Crystal", "Totem", "Gapple", "Pressure Plate"}));
   ...
   public WurstplusEAOffhand() {
      super(WurstplusCategory.WURSTPLUS_COMBAT);
      this.name = "EA Offhand";
      this.tag = "EAOffhand";
   ...
   public void update() {
      if (mc.field_71462_r != null && !(mc.field_71462_r instanceof GuiInventory)) {
         ...
         } else if (mc.field_71439_g.func_184614_ca().func_77973_b() == Items.field_185158_cP) {
            this.swap_items(this.get_item_slot(Items.field_190929_cY), this.delay.get_value(true) ? 1 : 0);
         } else if (mc.field_71439_g.func_184614_ca().func_77973_b() == Items.field_151153_ao) {
            this.swap_items(this.get_item_slot(Items.field_190929_cY), this.delay.get_value(true) ? 1 : 0);
         } else {
